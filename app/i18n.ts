...
export const messages: Record<Locale, MessageSet> = {
  ko: {
    ...
    payments: {
      ...
      title: ["제공 범위를 확인하고,", "구매 문의로 시작하세요."],
      description:
        "Professional과 Business는 정식 출시 전이며, 스마트스토어 실무팩은 현재 제공되는 디지털 상품입니다. 상품 결제 전에 구매 문의에서 범위와 일정을 확인합니다.",
      statusLabel: "문의 상태",
      status: "구매 문의 접수",
      products: [
        {
          ...
          features: ["정식 출시 전 구매 문의", "Chrome Extension은 공개 출시 후 제공", "Google Drive는 OAuth 승인 후 활성화"],
        ...
        },
        {
          ...
          features: ["Professional 제공 범위 포함", "Business Workspace는 개발 중", "우선 지원은 이메일로 제공"],
  ...
  en: {
    ...
    payments: {
      eyebrow: "PLANS & INQUIRY",
      title: ["Review what is available,", "then send a purchase inquiry."],
      description:
        "Professional and Business are pre-release. The SmartStore pack is a currently available digital product. Confirm scope and timing before any purchase.",
      statusLabel: "Inquiry status",
      status: "Purchase inquiries open",
      products: [
        {
          name: "AIWORK Professional",
          price: "USD 19",
          billing: "pre-release · scope review",
          features: ["Pre-release inquiry", "Chrome Extension after public release", "Google Drive after OAuth approval"],
          action: "Ask about Professional",
        },
        {
          name: "AIWORK Business",
          price: "USD 49",
          billing: "in development · scope review",
          features: ["Includes the Professional scope", "Business Workspace is in development", "Priority support is provided by email"],
          action: "Ask about Business",
        },
        {
          name: "Naver SmartStore Operations Pack",
          price: "USD 29",
          billing: "digital product · scope review",
          features: ["Product-page planning", "Titles, search keywords, and marketing copy", "Support scripts, checklists, and AI prompts"],
          action: "Ask about the operations pack",
        },
      ],
      supportTitle: "Support AIWORK",
      supportDescription:
  ...
  ja: {
    ...
    payments: {
      eyebrow: "PLANS & INQUIRY",
      title: ["提供範囲を確認してから", "購入相談を送信してください。"],
      description:
        "ProfessionalとBusinessは正式リリース前です。SmartStore実務パックは現在提供中のデジタル商品です。購入前に提供範囲と時期を確認します。",
      statusLabel: "相談状況",
      status: "購入相談受付中",
      products: [
        {
  ...
  "zh-CN": {
    ...
    payments: {
      eyebrow: "PLANS & INQUIRY",
      title: ["确认当前提供范围后，", "再提交购买咨询。"],
      description:
        "Professional 和 Business 尚未正式发布；SmartStore 实务包是目前可提供的数字商品。购买前请先确认范围和时间。",
      statusLabel: "咨询状态",
      status: "开放购买咨询",
      products: [
        {
  ...
  ar: {
    ...
    payments: {
      eyebrow: "PLANS & INQUIRY",
      title: ["راجع نطاق التوفر الحالي", "ثم أرسل استفسار شراء."],
      description:
        "Professional وBusiness قبل الإطلاق الرسمي، بينما حزمة SmartStore منتج رقمي متاح حالياً. أكّد النطاق والموعد قبل الشراء.",
      statusLabel: "حالة الاستفسار",
      status: "استفسارات الشراء متاحة",
      products: [
        {
          name: "AIWORK Professional",
          price: "USD 19",
          billing: "قبل الإطلاق · مراجعة النطاق",
          features: [
            "شراء مسبق قبل الإطلاق الرسمي",
            "يتوفر Chrome Extension بعد الإطلاق العام",
            "يُفعّل Google Drive بعد موافقة OAuth",
          ],
          action: "استفسر عن Professional",
        },
        {
          name: "AIWORK Business",
          price: "USD 49",
          billing: "قيد التطوير · مراجعة النطاق",
          features: ["يشمل نطاق Professional المسبق", "Business Workspace قيد التطوير", "دعم ذو أولوية عبر البريد الإلكتروني"],
          action: "استفسر عن Business",
        },
        {
          name: "حزمة تشغيل Naver SmartStore",
          price: "USD 29",
          billing: "منتج رقمي · مراجعة المحتوى",
          features: [
            "تخطيط صفحات المنتجات",
            "عناوين وكلمات بحث ونصوص تسويقية",
            "نصوص دعم وقوائم تحقق ومطالبات AI",
          ],
          action: "استفسر عن حزمة التشغيل",
        },
      ],
      supportTitle: "Support AIWORK",
      supportDescription:
  ...
  es: {
    ...
    payments: {
      eyebrow: "PLANS & INQUIRY",
      title: ["Revisa lo que está disponible", "y envía una consulta de compra."],
      description:
        "Professional y Business están en prelanzamiento. El paquete SmartStore es un producto digital disponible. Confirma alcance y fecha antes de comprar.",
      statusLabel: "Estado de consulta",
      status: "Consultas de compra abiertas",
      products: [
        {
          name: "AIWORK Professional",
          price: "USD 19",
          billing: "prelanzamiento · revisar alcance",
          features: [
        ...
        },
        {
          ...
          action: "Consultar el paquete operativo",
        },
      ],
      supportTitle: "Support AIWORK",
      supportDescription:
  ...
  fr: {
    ...
    payments: {
      eyebrow: "PLANS & INQUIRY",
      title: ["Vérifiez ce qui est disponible", "puis envoyez une demande d’achat."],
      description:
        "Professional et Business sont en prélancement. Le pack SmartStore est un produit numérique disponible. Confirmez le périmètre avant tout achat.",
      statusLabel: "État de la demande",
      status: "Demandes d’achat ouvertes",
      products: [
        {
          name: "AIWORK Professional",
          price: "USD 19",
          billing: "prélancement · périmètre à confirmer",
          features: [
            "Préachat avant le lancement officiel",
            "Chrome Extension après le lancement public",
            "Google Drive après l’approbation OAuth",
          ],
          action: "Demander Professional",
        },
        {
          name: "AIWORK Business",
          price: "USD 49",
          billing: "en développement · périmètre à confirmer",
          features: [
            "Inclut le périmètre de préachat Professional",
            "Business Workspace est en développement",
            "Support prioritaire par e-mail",
          ],
          action: "Demander Business",
        },
        {
          name: "Pack opérationnel Naver SmartStore",
          price: "USD 29",
          billing: "produit numérique · contenu à confirmer",
          features: [
            "Planification des pages produit",
            "Titres, mots-clés et textes marketing",
            "Scripts de support, listes de contrôle et prompts IA",
          ],
          action: "Demander le pack opérationnel",
        },
      ],
      supportTitle: "Support AIWORK",
      supportDescription:
  ...
  de: {
    ...
    payments: {
      eyebrow: "PLANS & INQUIRY",
      title: ["Prüfen Sie den aktuellen Umfang", "und senden Sie eine Kaufanfrage."],
      description:
        "Professional und Business befinden sich vor der Veröffentlichung. Das SmartStore-Paket ist ein verfügbares Digitalprodukt. Umfang und Termin werden vor dem Kauf bestätigt.",
      statusLabel: "Anfragestatus",
      status: "Kaufanfragen geöffnet",
      products: [
        {
          name: "AIWORK Professional",
          price: "USD 19",
          billing: "vor Veröffentlichung · Umfang prüfen",
          features: [
            "Vorabkauf vor der Veröffentlichung",
            "Chrome Extension nach öffentlicher Veröffentlichung",
            "Google Drive nach OAuth-Genehmigung",
          ],
          action: "Professional anfragen",
        },
        {
          name: "AIWORK Business",
          price: "USD 49",
          billing: "in Entwicklung · Umfang prüfen",
          features: [
            "Umfasst den Professional-Vorabumfang",
            "Business Workspace ist in Entwicklung",
            "Bevorzugter Support per E-Mail",
          ],
          action: "Business anfragen",
        },
        {
          name: "Naver SmartStore Praxispaket",
          price: "USD 29",
          billing: "Digitalprodukt · Inhalt prüfen",
          features: [
            "Planung von Produktseiten",
            "Titel, Suchbegriffe und Marketingtexte",
            "Supportvorlagen, Checklisten und KI-Prompts",
          ],
          action: "Praxispaket anfragen",
        },
      ],
      supportTitle: "Support AIWORK",
      supportDescription:
